...
def index(request):
    ...
    #Retrievve the top 5 only -- or all if less than 5.
...
def show_category(request, category_name_slug):
    ...
    try:
        ...
        #We get here if we didn't find the specifies category.
        #Don't do anything -
...
def add_category(request):
    ...
    #Will handle the bas form, new form. or no form supplied cases.
